...
const CreateCommunityModal:React.FC<CreateCommunityModalProps> = ({open, handleClose}) => {
    ...
    const handleCreateCommunity = async () => {
        ...
        try {
            ...
            handleClose()
            toggleMenuOpen()
            router.push(`forum/b/${communityName}`)
        } catch (error: any) {
        ...
        <>        
            <Modal isOpen={open} onClose={handleClose} size='lg'>
                ...
                <ModalContent bg='gray.100'>
                    ...
                    <Box pl={3} pr={3}>
                        ...
                        >
                            ...
                            <Text fontSize={11} color='gray.500'>
                                Community names including campitalization cannot be changed
                            </Text>
                            <Text 
                                position='relative' 
                                top='28px' 
                                ...
                                <Stack spacing={2}>
                                    ...
                                    >
                                        <Flex align='center'>
                                            ...
                                            <Text fontSize='8pt' color='gray.500'>
                                                Anyone can view community, but only approved users can post.
                                            </Text>
                                        </Flex>
                                    </Checkbox>
                                    <Checkbox 
                    ...
                    <ModalFooter bg='brand.400' borderRadius='0px 0px 10px 10px'>
