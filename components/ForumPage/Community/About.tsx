...
const About:React.FC<AboutProps> = ({communityData}) => {
    ...
    return (
        <Box position='sticky' top='14px'>
            <Flex justify='space-between' align='center' bg='brand.300' p={3} borderRadius='4px 4px 0px 0px'>
                <Text fontSize='10pt' fontWeight={700}>
                    About Community
                </Text>
                <Icon as={HiOutlineDotsHorizontal} />
            </Flex>
            <Flex direction='column' p={3} bg='brand.400' borderRadius='0px 0px 4px 4px'>
                <Stack>
                            ...
                            <Stack spacing={1} fontSize='10pt'>
                                ...
                                <Flex align='center' justify='space-between'>
                                    ...
                                    {communityData.imageURL || selectedFile ? (
                                        <Image src={selectedFile || communityData.imageURL} borderRadius='full' boxSize='40px' alt='Community Page'/>
                                    ) : (
                                        <Image 
                                            ...
                                            borderRadius='50%'
                                            alt='Default Community Page Image'
                                            mr={2}
                                        />
                                    )}
                                </Flex>
